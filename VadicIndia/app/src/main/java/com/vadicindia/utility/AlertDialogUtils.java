package com.vadicindia.utility;
...
public class AlertDialogUtils {
    ...
    public static void showMaterialDialogWithOneButton(Context context, final AlertDialogButtonListener buttonListener, final String... param) {
        androidx.appcompat.app.AlertDialog dialog;
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context,R.style.AlertDialogTheme);
        builder.setTitle(param[0])
                .setMessage(Html.fromHtml("<font color='#FF7F27'>"+param[1]+"</font>"))
    ...
    public static void showMaterialDialogWithTwoButton_2(Context context, final AlertDialogButtonListener buttonListener, final String... param) {
        androidx.appcompat.app.AlertDialog dialog;
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(context,R.style.AlertDialogTheme2);
