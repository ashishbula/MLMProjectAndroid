...
public class AdvanceWalletReportResponse extends BaseResponseEntity {

    String recordcount;//": "10",
    String credit;//": "3425.00",
    String debit;//": "10.00",
    String balance;//": "3415.00",
    AdavanceWallet achistory[];//": [
    ...
    public AdavanceWallet[] getAchistory() {
        return achistory;
    }

    public void setAchistory(AdavanceWallet[] achistory) {
        this.achistory = achistory;
    }

    public class AdavanceWallet{
        String sno;//": "1",
