...
public class RewardWalletResponse extends BaseResponseEntity {
    String recordcount;//": "10",
    String credit;//": "3425.00",
    String debit;//": "10.00",
    String balance;//": "3415.00",
     RewardWallet achistory[];//": [
    ...
    public RewardWallet[] getAchistory() {
        return achistory;
    }

    public void setAchistory(RewardWallet[] achistory) {
